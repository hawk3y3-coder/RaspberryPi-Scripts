...
GPIO.setup(27, GPIO.OUT)# set GPIO 25 as output for white led  
GPIO.setup(17, GPIO.OUT)# set GPIO 24 as output for red led  
  
white = GPIO.PWM(27, 100)    # create object white for PWM on port 25 at 100 Hertz  
red = GPIO.PWM(17, 100)      # create object red for PWM on port 24 at 100 Hertz  
